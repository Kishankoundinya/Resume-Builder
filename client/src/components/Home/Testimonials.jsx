...
const Testimonials = () => {
    ...
    const renderCard = (testimonial, index) => (
        <div key={`${testimonial.id}-${index}`} className="bg-linear-to-b from-[#020402] to-[#008236] border border-slate-800 rounded-xl p-6 mb-4 hover:border-slate-700 transition-all duration-300">
            <div className="mb-5">
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    <p className="text-sm text-slate-200">{testimonial.name}</p>
    ...
    return (
        <>
        <div id="testimonials" className="flex flex-col items-center pt-20 pb-5 scroll-mt-12 bg-black pt-4">
            <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 rounded-full px-6py-1.5">
                <BookUserIcon className="size-4.5 stroke-green-600" />
                <span className="font-medium">Testimonials</span>
            </div>
            <Title title="Praise & Perspectives" description="Discover how we’ve helped people transform their lives and achieve their goals." />
