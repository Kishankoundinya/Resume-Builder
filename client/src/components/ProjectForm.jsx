     ...
     <div >
            <div>
                <div className='flex items-center justify-between w-full'>
                    ...
                    <button className='flex items-center gap-2 px-3 py-1 text-sm bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-colors ' onClick={addProject}>
